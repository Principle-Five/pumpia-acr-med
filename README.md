...
2. Install the requirements using the command `pip install -r requirements.txt` when in the repository directory or use an environment manager to install the requirements from `requirements.txt`
